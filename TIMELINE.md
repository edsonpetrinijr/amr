...
| Dia | Resumo |
|-----|--------|
| [`2026-06-10`](docs/log/2026-06-10.md) | PoC Conversor de Torque: fluxo sim ponta-a-ponta implementado (3 PNs, BTLOG1→FLBT10TC1/2/3); branch `feat/poc-conversor-torque-sim`. |
