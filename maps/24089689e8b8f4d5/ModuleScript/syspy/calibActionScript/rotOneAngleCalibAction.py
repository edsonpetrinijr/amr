...
class Module(BasicModule):
    ...
    def run(self, r: SimModule, args):
        ...
        if self.init:
            ...
            self.move_angle = args.get("move_angle")
        ...
        if self.move_action == 0:
            self.status = r.runOdoMove({"move_angle":self.move_angle,  "speed_w":self.speed_w, "action_name":"GoRotForward"})
        ...
        r.logDebug("RotOneAngleCalibAction][{}|{}".format(
                    self.move_action,
                    self.status))
